...
Opdracht1: Maak een programma waarbij de spanning op de analoge ingang wordt gelezen en doorgestuurd wordt naar een seriële monitor (shell) op de PC.<br>
Gebruik de potentiometer op de shield.
</p>
</div>
